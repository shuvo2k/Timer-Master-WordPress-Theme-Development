...
<section id="blogposts" style="padding-bottom:40px;">
    <div class="container">
    <div class="album">
        <div class="container">
        <div class="section-heading">
...
?>
            ...
            <div class="card">
            <a href="<?php the_permalink(); ?>"><?php the_post_thumbnail('custom_thumb', ['class' => 'img-responsive card-img-top']); ?>
    </a>
            <div class="card-body">
            <h4 class="card-title"><?php the_title(); ?></h4>
            <p class="card-text"><?php the_excerpt(); ?></p>
            <a href="<?php the_permalink(); ?>" class="btn btn-primary"><?php echo $more; ?>Read More</a>
        </div>
        </div>
         </div> 
            <?php endwhile;
